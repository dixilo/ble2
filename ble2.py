...
def main():
    ...
    speed = ble2.get_status()
    print(f'current speed: {speed}')

    ble2.set_speed(1500)
    ble2.set_accl_time(5, False)
    ble2.set_accl_time(5, True)

    print('MOVING FORWARD')
    ble2.start(forward=True)
    for _ in range(200):
        print(f'{ble2.get_status()}')
        sleep(0.1)
